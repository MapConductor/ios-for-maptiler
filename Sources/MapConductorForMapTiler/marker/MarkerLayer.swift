...
final class MarkerLayer {
    ...
    func ensureAdded(to style: MLNStyle) {
        ...
        if existingLayer == nil {
            layer.iconImageName = NSExpression(forKeyPath: MapTilerMarkerRenderer.Prop.iconId)
            ...
            layer.iconOpacity = NSExpression(
                ...
                MapTilerMarkerRenderer.Prop.isHidden
            )
            ...
            // MapTiler renders style images as if they were @1x. We compensate by:
            ...
            layer.iconOffset = NSExpression(forKeyPath: MapTilerMarkerRenderer.Prop.iconAnchor)
    ...
    func setFeatures(_ features: [MLNPointFeature]) {
        ...
        // MapTiler can crash if we mutate a source that is no longer part of the current style
